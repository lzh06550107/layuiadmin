...
layui.define(["index", "layim"], function (exports) {
        ...
        setTimeout(function () {
            ...
            if("group" === To.type) {
                obj = {
                    ...
                    id: To.id,
                    type: To.type,
                    content: autoReplay[9 * Math.random() | 0]
                }
            } else {
                obj = {
                    username: To.name,
    ...
    var $ = layui.jquery, active = {
        ...
        removeFriend: function () {
            layer.msg("已成功删除[凤姐]", {icon: 1}), layim.removeList({id: 121286, type: "friend"})
        },
        removeGroup: function () {
            layer.msg("已成功删除[前端群]", {icon: 1}), layim.removeList({id: 101, type: "group"})
        },
        //置灰离线好友
        setGray: function () {
            layim.setFriendStatus(168168, "offline"), layer.msg("已成功将好友[马小云]置灰", {icon: 1})
        },
        //取消好友置灰
        unGray: function () {
            layim.setFriendStatus(168168, "online"), layer.msg("成功取消好友[马小云]置灰状态", {icon: 1})
        },
        kefu1: function () {
            layim.chat({
                name: "在线客服一",
        ...
        //移动端版本
        mobile: function () {
            var device = layui.device(), mobileHome = "/layim/demo/mobile.html";
            if (device.android || device.ios) return location.href = mobileHome;
