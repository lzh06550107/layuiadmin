...
layui.define(function (exports) {
                        ...
                        var echarea = [], area = [{
                            ...
                            tooltip: {
                                trigger: "axis", formatter: function (params) {
                                    return params[0].name + "<br/>" + params[0].seriesName + " : " + params[0].value + " (m^3/s)<br/>" + params[1].seriesName + " : " + -params[1].value + " (mm)"
                                }
                            },
    ...
    //柱状图
    layui.use(["carousel", "echarts"], function () {
        var e = layui.$, carousel = layui.carousel, echarts = layui.echarts,
            //标准柱状图
            echnormcol = [], normcol = [{
            ...
            elemNormcol = e("#LAY-index-normcol").children("div"),
        ...
        if (elemNormcol[0]) {
            ...
            var echheapcol = [], heapcol = [{
                ...
                elemHeapcol = e("#LAY-index-heapcol").children("div"),
            ...
            if (elemHeapcol[0]) {
                ...
                var echdiffcol = [], diffcol = [{
                    ...
                    elemDiffcol = e("#LAY-index-diffcol").children("div"),
                ...
                if (elemDiffcol[0]) {
                    ...
                    var echcolorline = [], colorline = [{
                        ...
                        elemColorline = e("#LAY-index-colorline").children("div"),
                    ...
                    if (elemColorline[0]) {
                        ...
                        var echnormbar = [], normbar = [{
                            ...
                            elemNormbar = e("#LAY-index-normbar").children("div"),
                        ...
                        if (elemNormbar[0]) {
                            ...
                            var echheapbar = [], heapbar = [{
                                ...
                                elemheapbar = e("#LAY-index-heapbar").children("div"),
                            ...
                            if (elemheapbar[0]) {
                                ...
                                var echwindline = [], labelRight = {normal: {label: {position: "right"}}}, windline = [{
                                    ...
                                    series: [{
                                        ...
                                        data: [{value: -.07, itemStyle: labelRight}, {
                                            value: -.09,
                                            itemStyle: labelRight
                                        }, .2, .44, {value: -.23, itemStyle: labelRight}, .08, {
                                            value: -.17,
                                            itemStyle: labelRight
                                        }, .47, {value: -.36, itemStyle: labelRight}, .18]
                                    }]
                                }],

                                    elemwindline = e("#LAY-index-windline").children("div"),
                                ...
                                elemwindline[0] && renderwindline(0);
                            }
                        }
                    }
                }
